...
<h2 id="代码拆分-code-splitting" tabindex="-1"><a class="header-anchor" href="#代码拆分-code-splitting"><span>代码拆分（Code Splitting）</span></a></h2>
<h2 id="资源模块-asset-modules" tabindex="-1"><a class="header-anchor" href="#资源模块-asset-modules"><span>资源模块（Asset Modules）</span></a></h2>
<p>js可以引入css、图片等资源，webpack5之前需要使用file-loader、url-loader等loader，webpack5之后可以直接使用资源模块。</p>
</div></template>
